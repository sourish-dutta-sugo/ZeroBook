...
private fun IncomeEntryScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(value = "INC/${viewModel.financialYear.value}/${System.currentTimeMillis().toString().takeLast(4)}", onValueChange = {}, readOnly = true, label = { Text("Income No") }, modifier = Modifier.fillMaxWidth())
            OutlinedTextField(
                value = category,
                onValueChange = {},
                readOnly = true,
                    ...
                    if (amountValue <= 0.0) {
                        ...
                        viewModel.saveIncome(
                            Income(
                                ...
                                voucherNo = "INC/${viewModel.financialYear.value}/${System.currentTimeMillis().toString().takeLast(4)}"
                            )
                        ) {
                            onDismiss()
                        }
