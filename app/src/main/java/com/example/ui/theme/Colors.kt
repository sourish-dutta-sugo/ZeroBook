...
object Colors {
    ...
    val textSecondary = Color(0xFF444444) // textSecondary
    ...
    val drBalance = Color(0xFFC62828) // Debit: Red
    val crBalance = Color(0xFF1E8A3C) // Credit: Green

    val sectionHeaderBg = Color(0xFFEEF2FF)
    val sectionHeaderText = Color(0xFF1A73E8)
    val tableHeaderText = Color(0xFF1A73E8)

    // Badges
    val badgeSale = Color(0xFFE6F4EA)
    val badgeSaleText = Color(0xFF1E8A3C)
    val badgePurchase = Color(0xFFFFF3E0)
    val badgePurchaseText = Color(0xFFE65100)
    val badgeReturn = Color(0xFFFDECEA)
    val badgeReturnText = Color(0xFFC62828)
    val badgeReceipt = Color(0xFFE8F0FE)
    val badgeReceiptText = Color(0xFF1A73E8)
    val badgePayment = Color(0xFFE8F0FE)
    val badgePaymentText = Color(0xFF1A73E8)
}
